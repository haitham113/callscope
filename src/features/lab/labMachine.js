...
export const LAB_TRANSITIONS = Object.freeze({
  ...
  healthy: Object.freeze(['degraded', 'critical', 'verifying', 'ended', 'failed']),
  degraded: Object.freeze(['diagnosing', 'awaiting_approval', 'verifying', 'healthy', 'ended', 'failed']),
  critical: Object.freeze(['diagnosing', 'awaiting_approval', 'verifying', 'healthy', 'ended', 'failed']),
  diagnosing: Object.freeze(['degraded', 'critical', 'awaiting_approval', 'verifying', 'ended', 'failed']),
  awaiting_approval: Object.freeze(['degraded', 'critical', 'recovering', 'verifying', 'ended', 'failed']),
  recovering: Object.freeze(['verifying', 'degraded', 'critical', 'ended', 'failed']),
